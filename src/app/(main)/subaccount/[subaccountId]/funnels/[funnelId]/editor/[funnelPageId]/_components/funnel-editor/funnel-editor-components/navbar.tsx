...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="/assets/r-logo.png" className="h-8" alt="Ripple Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ripple</span>
  </a>
