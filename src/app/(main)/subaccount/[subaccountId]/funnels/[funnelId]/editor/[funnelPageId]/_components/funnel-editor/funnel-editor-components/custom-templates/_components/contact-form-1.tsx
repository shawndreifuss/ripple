...
const ContactForm1 = ({ apiCall, title }: Props) => {
  ...
  return (
    <>
      {/* <!-- ===== Contact Start ===== --> */}
      <section id="support" className="px-4 md:px-8 2xl:px-0 z-50">
        <div className="relative mx-auto max-w-c-1390 px-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-20">
          <div className="absolute left-0 top-0 -z-1 h-2/3 w-full rounded-lg bg-gradient-to-t from-transparent to-[#dee7ff47] dark:bg-gradient-to-t dark:to-[#252A42]"></div>
          
          {/* ========  Troubleshooty background =========== */}
          {/* <div className="absolute bottom-[-255px] left-0 -z-1 h-full w-full">
            <Image
              src="./images/shape-dotted.svg"
              alt="Dotted"
          ...
          <div className="flex flex-col-reverse flex-wrap gap-8 md:flex-row md:flex-nowrap md:justify-between xl:gap-20">
            ...
            >
              ...
              >
                <div className="mb-7.5 w-full flex flex-col lg:flex-row lg:justify-start lg:gap-10">
            ...
            />
                ...
                <div className="mb-11.5 w-full flex justify-center ">  
                <div className="w-full">
                <FormField
              disabled={isLoading}
              control={form.control}
