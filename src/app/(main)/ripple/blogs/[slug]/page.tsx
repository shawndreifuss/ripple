...
// Function to split the text and apply bold formatting
const boldRipple = (text: string) => {
  console.log(text)
  return text.replace(/Ripple/g, "<strong className='text-primary'>Ripple</strong>");
};
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div dangerouslySetInnerHTML={{ __html: boldRipple(`${post.title}`) }} />
                  </h2>
                 <h4 className="mb-12 text-2xl font-bold leading-tight text-primary dark:text-white sm:text-xl sm:leading-tight"><div dangerouslySetInnerHTML={{ __html: boldRipple(`${post.paragraph}`) }} /></h4>
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  ...
                  <div className="mb-5">
                    <a
                      href="#0"
                      className="inline-flex mx-2 items-center justify-center rounded-full bg-primary px-4 py-2 text-sm font-semibold text-white"
                    >
                      Development
                    </a>
                    <a
 ...
 <div dangerouslySetInnerHTML={{ __html: boldRipple(`${post.article?.slice(0, 272)}`) }} />
                  </p>
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                   <div dangerouslySetInnerHTML={{ __html: boldRipple(`${post.article?.slice(272, 829)}`) }} />
                 
                  </p>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                 <div dangerouslySetInnerHTML={{ __html: boldRipple(`${post.article?.slice(829, 2998)}`)}} />
                  </p>
                  <h3 className="font-xl mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                  <div dangerouslySetInnerHTML={{ __html: boldRipple(`${post.article?.slice(2998, 3228)}`) }} />
                  </h3>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  <div dangerouslySetInnerHTML={{ __html: boldRipple(`${post.article?.slice(3228, 7000)}`) }} />
                  </p>
                  
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium italic text-body-color">
                      
"Experience the power of <strong >Ripple</strong> The New Way in business innovation. Try us out today and discover a new frontier of success."
                    </p>
